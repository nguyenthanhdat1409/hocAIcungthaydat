...
Object.assign(window.LESSON_QUIZ, {
  ...
  "1.2.1": [
    ...
    {q:"Hàng phím cơ sở đặt 8 ngón ở những phím nào?", o:["A S D F và J K L ;","Q W E R T","Z X C V B","1 2 3 4"], a:0},
    {q:"Vì sao phím F và J có gờ nổi nhỏ?", o:["Để đặt hai ngón trỏ đúng chỗ mà không cần nhìn","Để trang trí cho đẹp","Để tắt máy","Vì bàn phím bị lỗi"], a:0}
  ],
  ...
  "1.2.2": [
    ...
    {q:"Hàng phím trên gồm những phím nào?", o:["Q W E R T Y U I O P","A S D F J K L ;","Z X C V B N","Các phím số"], a:0},
    {q:"Sau khi vươn lên gõ hàng phím trên, ngón tay nên làm gì?", o:["Trở về hàng cơ sở (vị trí 'nhà')","Bấm giữ luôn phím đó","Rời hẳn khỏi bàn phím","Chuyển sang gõ số"], a:0}
  ],
  ...
  "1.2.3": [
    ...
    {q:"Phím cách (Space) thường được gõ bằng ngón nào?", o:["Ngón cái","Ngón út","Ngón trỏ tay trái","Không dùng ngón nào"], a:0},
    {q:"Hàng phím dưới gồm những phím nào?", o:["Z X C V B N M , . /","Q W E R T","A S D F","F1 F2 F3"], a:0}
  ],
  ...
  "1.2.4": [
    ...
    {q:"Muốn gõ CHỮ HOA, em làm thế nào?", o:["Giữ phím Shift rồi gõ chữ","Gõ chữ đó hai lần","Bấm phím cách","Bấm Enter"], a:0},
    {q:"Dấu nào dùng để KẾT THÚC một câu kể?", o:["Dấu chấm (.)","Dấu phẩy (,)","Dấu hỏi (?)","Phím cách"], a:0}
  ],
  ...
  "1.2.5": [
    ...
    {q:"Kiểu gõ Telex: gõ 'as' sẽ ra chữ gì?", o:["á","à","ả","ạ"], a:0},
    {q:"Kiểu gõ Telex: để có chữ 'â' em gõ hai chữ nào?", o:["aa","aw","ow","ee"], a:0}
  ],
  ...
  "1.2.6": [
    ...
    {q:"Một mật khẩu MẠNH nên có gì?", o:["Chữ hoa, chữ thường, số và ký tự đặc biệt","Chỉ toàn số 1","Chính tên của mình","Càng ngắn càng tốt"], a:0},
    {q:"Để gõ dấu '!' (nằm trên phím số 1), em làm gì?", o:["Giữ Shift rồi bấm phím số 1","Bấm phím 1 hai lần","Bấm phím cách","Bấm Enter"], a:0}
  ],
  ...
  "1.2.7": [
    ...
    {q:"Chỉ số WPM đo điều gì?", o:["Số từ gõ đúng trong một phút","Số lần tắt máy","Dung lượng ổ cứng","Độ sáng màn hình"], a:0},
    {q:"Khi luyện gõ phím, nên ưu tiên điều gì trước?", o:["Gõ đúng trước, rồi mới tăng tốc","Nhanh bằng mọi giá","Nhìn phím thật kỹ","Gõ thật mạnh tay"], a:0}
  ],
  ...
  "1.2.8": [
    ...
    {q:"Bài kiểm tra gõ phím đo những gì?", o:["Cả tốc độ lẫn độ chính xác","Chỉ màu của bàn phím","Số ứng dụng đang mở","Dung lượng pin"], a:0},
    {q:"Ghi lại WPM qua nhiều buổi để làm gì?", o:["Để thấy mình tiến bộ dần","Để khoe điểm kém","Để tắt máy nhanh hơn","Không có tác dụng gì"], a:0}
  ],
  ...
  "1.3.1": [
    ...
    {q:"AI (trí tuệ nhân tạo) là gì?", o:["Máy tính làm được việc tưởng chỉ người mới làm được","Một loại pin","Một môn thể thao","Một loại bàn phím"], a:0},
    {q:"Câu nào ĐÚNG về AI hiện nay?", o:["AI giỏi từng việc nhờ học nhiều ví dụ, không có cảm xúc thật","AI biết tuốt mọi thứ","AI có cảm xúc thật như người","AI không cần dữ liệu"], a:0}
  ],
  ...
  "1.3.2": [
    ...
    {q:"Chatbot là gì?", o:["AI mà em trò chuyện bằng cách gõ câu hỏi","Một loại robot hút bụi","Một trò chơi điện tử","Một chiếc loa"], a:0},
    {q:"Câu trả lời của AI nên được xem là gì?", o:["Thông tin tham khảo, cần kiểm chứng nếu quan trọng","Luôn đúng tuyệt đối","Bí mật không được đọc","Hoàn toàn vô dụng"], a:0}
  ],
  ...
  "1.3.3": [
    ...
    {q:"Google khác AI ở điểm nào?", o:["Google đưa danh sách trang web có sẵn; AI tự viết câu trả lời mới","Cả hai giống hệt nhau","Google là một robot","AI chỉ tìm được ảnh"], a:0},
    {q:"Vì sao câu trả lời 'tự viết' của AI đôi khi sai?", o:["Vì nó tạo mới nên có thể thiếu chính xác, cần đối chiếu nguồn","Vì mạng chậm","Vì màn hình nhỏ","Vì máy thiếu pin"], a:0}
  ],
  ...
  "1.3.4": [
    ...
    {q:"Vì sao không nên tin AI 100%?", o:["AI đôi khi bịa thông tin nghe xuôi tai nhưng sai","AI luôn buồn ngủ","AI sợ ánh sáng","AI chỉ nói tiếng Anh"], a:0},
    {q:"Với thông tin quan trọng từ AI, em nên làm gì?", o:["Kiểm tra lại ở sách hoặc trang chính thống","Tin ngay lập tức","Xoá đi cho chắc","Chia sẻ liền cho cả lớp"], a:0}
  ],
  ...
  "1.3.5": [
    ...
    {q:"Câu hỏi nào giúp AI trả lời tốt hơn?", o:["Giải thích cho em lớp 3 vì sao chó là bạn của người, trong 3 câu","Kể về chó","Nói gì đó đi","Chó"], a:0},
    {q:"Nếu AI trả lời chưa ưng ý, em nên làm gì?", o:["Nói rõ muốn sửa gì rồi hỏi lại","Bỏ cuộc ngay","Đập bàn phím","Khen đại cho xong"], a:0}
  ],
  ...
  "1.3.6": [
    ...
    {q:"Điều nào em KHÔNG nên chia sẻ với AI?", o:["Mật khẩu, địa chỉ nhà, số điện thoại","Một câu hỏi Toán","Tên loài hoa em thích","Màu em yêu thích"], a:0},
    {q:"Gặp nội dung khó chịu hoặc đáng lo khi dùng AI, em nên?", o:["Báo người lớn (ba mẹ, thầy cô)","Im lặng làm theo","Chia sẻ cho bạn bè","Tin đó là thật"], a:0}
  ],
  ...
  "1.4.1": [
    ...
    {q:"Một prompt tốt thường đủ 3 phần nào?", o:["Bối cảnh – Yêu cầu – Định dạng","Tên – Tuổi – Lớp","Mở – Thân – Kết","Sáng – Trưa – Tối"], a:0},
    {q:"'Trả lời trong 3 câu' thuộc phần nào của prompt?", o:["Định dạng mong muốn","Bối cảnh","Lời chào","Mật khẩu"], a:0}
  ],
  ...
  "1.4.2": [
    ...
    {q:"'Cho AI đóng vai' có tác dụng gì?", o:["Giúp câu trả lời hợp mục đích hơn","Làm AI chạy nhanh hơn","Tắt được máy","Xoá lịch sử trò chuyện"], a:0},
    {q:"Muốn câu trả lời DỄ HIỂU, nên cho AI đóng vai gì?", o:["Thầy/cô giáo","Người lạ khó tính","Máy pha cà phê","Chiếc xe đạp"], a:0}
  ],
  ...
  "1.4.3": [
    ...
    {q:"Muốn kết quả gọn dạng bảng, em nên?", o:["Yêu cầu AI 'trả lời bằng bảng'","Không nói gì cả","Gõ thật nhiều chữ","Bấm Enter nhiều lần"], a:0},
    {q:"Cách nào giới hạn độ dài câu trả lời?", o:["Nói 'trong 3 câu' hoặc 'khoảng 100 chữ'","Viết hoa toàn bộ","Gửi câu hỏi trống","Tắt mạng"], a:0}
  ],
  ...
  "1.4.4": [
    ...
    {q:"Chưa ưng câu trả lời, em nên làm gì?", o:["Hỏi tiếp: 'ngắn hơn', 'dễ hiểu hơn', 'thêm ví dụ'","Bỏ cuộc ngay","Xoá ứng dụng","Chép đại cho xong"], a:0},
    {q:"Làm việc với AI giống như?", o:["Trò chuyện nhiều lượt","Hỏi một lần là xong","Đọc sách giấy","Xem tivi"], a:0}
  ],
  ...
  "1.4.5": [
    ...
    {q:"Cách dùng AI để HỌC đúng đắn là?", o:["Nhờ AI giải thích để tự hiểu bài","Chép y nguyên đáp án","Nhờ AI làm hết bài thi","Giấu việc mình dùng AI"], a:0},
    {q:"AI có thể giúp ôn tập bằng cách nào?", o:["Tạo câu đố ôn tập môn còn yếu","Đi học thay em","Chấm thi chính thức","Làm bài kiểm tra hộ"], a:0}
  ],
  ...
  "1.4.6": [
    ...
    {q:"Khi sáng tạo cùng AI, sản phẩm là của em khi nào?", o:["Khi em chọn lọc và thêm màu sắc riêng","Khi để AI làm hết","Khi chép nguyên xi","Khi giấu nguồn gốc"], a:0},
    {q:"Cách hay để lấy nhiều ý tưởng từ AI?", o:["Đề nghị 'cho em 5 ý tưởng khác nhau' rồi chọn","Chỉ hỏi một câu cụt lủn","Không hỏi gì","Bấm ngẫu nhiên"], a:0}
  ]
...
Object.assign(window.LESSON_QUIZ, {
  ...
  "1.5.1": [
    ...
    {q:"'Phân rã vấn đề' nghĩa là gì?", o:["Chia việc lớn thành nhiều việc nhỏ dễ làm","Bỏ luôn việc lớn","Làm thật nhanh cho xong","Nhờ người khác làm hết"], a:0},
    {q:"'Dọn phòng' có thể chia thành những việc nhỏ nào?", o:["Gấp quần áo + xếp sách + lau bàn + đổ rác","Chỉ cần ngồi im","Một việc duy nhất không chia được","Bật nhạc lên"], a:0}
  ],
  ...
  "1.5.2": [
    ...
    {q:"Vì sao thứ tự các bước quan trọng?", o:["Làm sai thứ tự có thể ra kết quả hỏng","Không quan trọng gì","Chỉ để cho vui","Làm mọi thứ chậm lại"], a:0},
    {q:"Làm bánh: việc nào phải làm TRƯỚC?", o:["Trộn bột trước khi nướng","Nướng trước khi trộn bột","Ăn trước khi làm","Dọn dẹp trước tiên"], a:0}
  ],
  ...
  "1.5.3": [
    ...
    {q:"Quy luật (pattern) là gì?", o:["Điều lặp lại mà ta có thể đoán tiếp","Một lỗi của máy tính","Một loại phím","Một trò chơi"], a:0},
    {q:"Dãy 2, 4, 6, 8… theo quy luật nào?", o:["Cộng 2","Nhân 3","Trừ 1","Ngẫu nhiên"], a:0}
  ],
  ...
  "1.5.4": [
    ...
    {q:"'Trừu tượng hoá' nghĩa là gì?", o:["Giữ điều quan trọng, bỏ chi tiết thừa","Thêm thật nhiều chi tiết","Xoá hết thông tin","Vẽ một bức tranh"], a:0},
    {q:"Kể lại một chuyện dài trong 3 câu, em cần?", o:["Chọn ý chính, bỏ chi tiết vụn vặt","Kể hết mọi chi tiết","Không kể gì","Đọc nguyên văn"], a:0}
  ],
  ...
  "1.5.5": [
    ...
    {q:"Tư duy máy tính gồm những kỹ năng nào?", o:["Chia nhỏ, sắp thứ tự, tìm quy luật, bỏ chi tiết thừa","Chạy nhanh, nhảy cao","Hát và múa","Vẽ và tô màu"], a:0},
    {q:"Tư duy máy tính giúp em điều gì?", o:["Giải mọi loại vấn đề, không chỉ trên máy tính","Chỉ dùng khi lập trình","Không dùng được ngoài đời","Chỉ để đi thi"], a:0}
  ],
  ...
  "1.5.6": [
    ...
    {q:"Trình bày cách giải tốt là như thế nào?", o:["Nói theo từng bước, có ví dụ, tránh nói tắt","Nói thật nhanh cho xong","Giấu bớt các bước","Chỉ nói mỗi kết quả"], a:0},
    {q:"Làm sao biết mình đã giải thích tốt?", o:["Bạn làm theo lời em và thành công","Không ai hiểu gì","Em tự thấy hay là được","Nói càng dài càng tốt"], a:0}
  ],
  ...
  "1.6.1": [
    ...
    {q:"Thuật toán là gì?", o:["Chuỗi bước rõ ràng để máy làm theo và hoàn thành một việc","Một loại virus","Tên một trò chơi","Một phím tắt"], a:0},
    {q:"Ví dụ nào là thuật toán trong đời thường?", o:["Công thức nấu ăn","Một bức ảnh","Một bài hát","Một chiếc ghế"], a:0}
  ],
  ...
  "1.6.2": [
    ...
    {q:"Trong flowchart, hình THOI dùng để làm gì?", o:["Một câu hỏi (rẽ nhánh Đúng/Sai)","Bắt đầu/kết thúc","Một hành động","Trang trí"], a:0},
    {q:"Hình OVAL trong flowchart thể hiện điều gì?", o:["Bắt đầu / kết thúc","Một câu hỏi","Một phép nhân","Một vòng lặp"], a:0}
  ],
  ...
  "1.6.3": [
    ...
    {q:"'Input' của một bài toán là gì?", o:["Cái được đưa vào","Cái nhận ra ở cuối","Màu của màn hình","Tên của máy"], a:0},
    {q:"Máy tính bỏ túi: Output (đầu ra) là gì?", o:["Kết quả phép tính","Các con số em bấm","Cục pin","Nút nguồn"], a:0}
  ],
  ...
  "1.6.4": [
    ...
    {q:"'Dry run' (chạy tay) là gì?", o:["Lần theo flowchart từng bước với dữ liệu cụ thể","Cho máy chạy thật ngay","Xoá flowchart","Tắt máy đi"], a:0},
    {q:"Dry run giúp ích gì?", o:["Bắt lỗi sớm trước khi cho máy chạy thật","Làm máy nhanh hơn","Trang trí flowchart","Tăng điểm số"], a:0}
  ],
  ...
  "1.6.5": [
    ...
    {q:"Pseudo-code là gì?", o:["Viết các bước bằng tiếng Việt có cấu trúc","Một ngôn ngữ bí mật","Một loại phím","Một trò chơi"], a:0},
    {q:"Câu nào là ví dụ pseudo-code?", o:["NẾU trời mưa THÌ mang ô; NGƯỢC LẠI đội mũ","Xin chào các bạn","Con mèo màu đen","Hôm nay trời đẹp"], a:0}
  ],
  ...
  "1.6.6": [
    ...
    {q:"Thuật toán có thể sai vì lý do nào?", o:["Thiếu bước, sai thứ tự, hoặc quên trường hợp đặc biệt","Máy quá mới","Màn hình quá sáng","Bàn phím đẹp"], a:0},
    {q:"Khi mắc lỗi trong thuật toán, điều quan trọng là?", o:["Biết tìm ra và sửa lỗi","Bỏ cuộc","Giấu lỗi đi","Đổ lỗi cho máy"], a:0}
  ],
  ...
  "1.6.7": [
    ...
    {q:"Khi AI góp ý cho flowchart của em, em nên?", o:["Tự đánh giá, chỉ giữ lại điều hợp lý","Tin theo tất cả","Bỏ hết ý của mình","Không bao giờ nghe AI"], a:0},
    {q:"Ai là người quyết định cuối cùng?", o:["Em — AI chỉ là trợ lý","AI quyết hết","Chiếc máy tính","Người ngồi cạnh"], a:0}
  ],
  ...
  "1.6.8": [
    ...
    {q:"Quy trình giải một bài toán là gì?", o:["Hiểu đề → phân rã → flowchart → dry run","Đoán đại đáp án","Chép của bạn","Tắt máy rồi bật lại"], a:0},
    {q:"Quy trình này áp dụng cho?", o:["Mọi bài toán em gặp sau này","Chỉ một bài duy nhất","Chỉ môn Toán","Không dùng được"], a:0}
  ],
  ...
  "1.7.1": [
    ...
    {q:"Scratch lập trình bằng cách nào?", o:["Kéo thả các khối lệnh, không cần gõ code","Gõ toàn chữ khó","Nói vào micro","Vẽ bằng tay"], a:0},
    {q:"'Sân khấu' trong Scratch là gì?", o:["Nơi nhân vật hoạt động","Nút tắt máy","Một loại phím","Thùng rác"], a:0}
  ],
  ...
  "1.7.2": [
    ...
    {q:"Khối 'Nếu… thì…' (if/else) dùng để làm gì?", o:["Cho nhân vật phản ứng khác nhau tuỳ tình huống","Tắt máy","Vẽ hình tròn","Tăng âm lượng"], a:0},
    {q:"Điều kiện trong if/else giống hình nào ở flowchart?", o:["Hình thoi (câu hỏi Đúng/Sai)","Hình oval","Hình chữ nhật","Mũi tên"], a:0}
  ],
  ...
  "1.7.3": [
    ...
    {q:"Phép 'VÀ' đúng khi nào?", o:["Khi CẢ HAI điều kiện đều đúng","Khi ít nhất một điều kiện đúng","Khi cả hai đều sai","Luôn luôn đúng"], a:0},
    {q:"Phép 'HOẶC' đúng khi nào?", o:["Khi ÍT NHẤT MỘT điều kiện đúng","Chỉ khi cả hai đúng","Khi cả hai sai","Không bao giờ"], a:0}
  ],
  ...
  "1.7.4": [
    ...
    {q:"Vòng lặp dùng để làm gì?", o:["Lặp lại một việc mà không phải chép lệnh nhiều lần","Tắt chương trình","Xoá nhân vật","Đổi màu nền"], a:0},
    {q:"Vẽ hình vuông bằng vòng lặp cần lặp mấy lần?", o:["4 lần (đi tới + quay 90°)","1 lần","10 lần","Mãi mãi"], a:0}
  ],
  ...
  "1.7.5": [
    ...
    {q:"Biến số là gì?", o:["'Chiếc hộp' lưu một giá trị có thể thay đổi","Một khối hình cố định","Một loại phím","Một nhân vật"], a:0},
    {q:"Nên đặt tên biến thế nào cho tốt?", o:["Dễ hiểu như 'diem', 'mang'","Càng khó hiểu càng tốt","Toàn ký tự lạ","Để trống"], a:0}
  ],
  ...
  "1.7.6": [
    ...
    {q:"Trò 'bắt táo' dùng những khối kiến thức nào?", o:["Vòng lặp + if/else + biến","Chỉ vòng lặp","Chỉ biến","Không dùng gì"], a:0},
    {q:"if/else, vòng lặp và biến là gì của lập trình?", o:["Nền tảng của hầu hết chương trình và trò chơi","Chỉ để trang trí","Không quan trọng","Chỉ dùng ở Scratch"], a:0}
  ],
  ...
  "1.8.1": [
    ...
    {q:"Bước lập kế hoạch dự án gồm những gì?", o:["Chọn vấn đề, phân rã thành bước, vẽ flowchart","Làm ngay không cần kế hoạch","Chép của bạn","Chờ người khác làm"], a:0},
    {q:"Nên chọn vấn đề cho dự án thế nào?", o:["Vừa sức và em thật sự quan tâm","Càng khó càng tốt","Vấn đề của người khác","Vấn đề không liên quan"], a:0}
  ],
  ...
  "1.8.2": [
    ...
    {q:"Khi xây sản phẩm, nên làm phần nào trước?", o:["Phần cốt lõi chạy được, chi tiết đẹp để sau","Trang trí trước tiên","Phần khó nhất trước","Làm hết rồi mới thử"], a:0},
    {q:"Cách làm nào giúp dễ tìm lỗi hơn?", o:["Làm từng phần nhỏ và thử ngay","Làm hết rồi mới chạy","Không thử gì cả","Xoá đi làm lại từ đầu"], a:0}
  ],
  ...
  "1.8.3": [
    ...
    {q:"'Kiểm thử' sản phẩm là gì?", o:["Nhờ người khác dùng thử để tìm lỗi mình không thấy","Tự khen sản phẩm","Xoá sản phẩm đi","Giấu không cho ai xem"], a:0},
    {q:"Bị góp ý nên hiểu thế nào cho đúng?", o:["Là cách giúp sản phẩm tốt lên, không phải thất bại","Là mình quá dở","Nên bỏ cuộc","Nên giận bạn"], a:0}
  ],
  ...
  "1.8.4": [
    ...
    {q:"Trình bày Demo Day nên theo mạch nào?", o:["Vấn đề → Cách giải → Demo","Demo → Chào → Vấn đề","Chỉ đọc code","Không cần trình bày"], a:0},
    {q:"Làm sao để nói trôi chảy, đỡ hồi hộp?", o:["Luyện nói trước gương hoặc với bạn vài lần","Không chuẩn bị gì","Đọc thật nhanh","Nói càng dài càng tốt"], a:0}
  ]
...
Object.assign(window.LESSON_QUIZ, {
  ...
  "2.1.1": [
    ...
    {q:"AI hôm nay có thể làm được gì?", o:["Viết, vẽ, trò chuyện, lập trình phụ — nhưng vẫn có thể sai","Làm mọi thứ hoàn hảo tuyệt đối","Không làm được gì cả","Chỉ biết tính toán"], a:0},
    {q:"Dù tiến rất xa, AI vẫn?", o:["Giỏi từng việc cụ thể và vẫn có thể sai","Biết tuốt mọi thứ","Không cần dữ liệu","Có cảm xúc thật như người"], a:0}
  ],
  ...
  "2.1.2": [
    ...
    {q:"Bài kiểm tra đầu vào dùng để làm gì?", o:["Biết mình đang ở đâu để đặt mục tiêu đúng","So hơn thua với bạn","Lấy điểm thật cao","Trang trí hồ sơ"], a:0},
    {q:"Nên làm bài test đầu vào thế nào?", o:["Làm thật lòng để kết quả có ích","Chép của bạn","Đoán bừa cho nhanh","Bỏ trống"], a:0}
  ],
  ...
  "2.1.3": [
    ...
    {q:"Một mục tiêu tốt nên như thế nào?", o:["Cụ thể và đo được","Mơ hồ, chung chung","Của người khác","Càng nhiều càng tốt"], a:0},
    {q:"Nên chọn bao nhiêu mục tiêu để theo đuổi?", o:["Khoảng 3 mục tiêu, theo đến cùng","20 mục tiêu một lúc","Không cần mục tiêu","Càng nhiều càng tốt"], a:0}
  ],
  ...
  "2.1.4": [
    ...
    {q:"Teachable Machine giúp em làm gì?", o:["Tự dạy máy phân biệt đồ vật bằng ảnh","Chơi game bắn súng","Luyện gõ phím","Vẽ tranh 3D"], a:0},
    {q:"Dùng Teachable Machine có cần biết lập trình không?", o:["Không cần biết lập trình","Phải rất giỏi lập trình","Phải học 5 năm","Bắt buộc gõ code"], a:0}
  ],
  ...
  "2.2.1": [
    ...
    {q:"Vì sao nói 'dữ liệu là thức ăn của AI'?", o:["AI học từ ví dụ (dữ liệu), không được lập trình sẵn từng câu","Vì AI ăn thật","Vì dữ liệu là pin","Vì dữ liệu để trang trí"], a:0},
    {q:"Câu 'rác vào thì rác ra' nghĩa là gì?", o:["Dữ liệu xấu thì AI học kém","AI thích rác","Máy sẽ hỏng ngay","Không liên quan gì tới AI"], a:0}
  ],
  ...
  "2.2.2": [
    ...
    {q:"Ba bước huấn luyện một mô hình là?", o:["Thu ảnh → huấn luyện → thử với vật mới","Bật máy → tắt máy → nghỉ","Vẽ → tô màu → in ra","Hỏi → đáp → xoá"], a:0},
    {q:"Nên chụp ảnh mẫu để dạy máy thế nào?", o:["Nhiều góc, đủ sáng","Chỉ một góc, tối om","Ảnh càng mờ càng tốt","Không cần ảnh"], a:0}
  ],
  ...
  "2.2.3": [
    ...
    {q:"Dữ liệu 'xấu' (ảnh mờ, thiếu đa dạng) gây ra điều gì?", o:["Khiến mô hình đoán sai","Làm mô hình giỏi hơn","Không ảnh hưởng gì","Tăng tốc máy"], a:0},
    {q:"Dữ liệu 'tốt' là như thế nào?", o:["Ảnh rõ, nhiều góc, đủ trường hợp","Chỉ một tấm ảnh mờ","Toàn ảnh giống hệt nhau","Không có ảnh nào"], a:0}
  ],
  ...
  "2.2.4": [
    ...
    {q:"'Thiên vị' (bias) trong dữ liệu là gì?", o:["Dữ liệu học bị lệch, thiếu đa dạng","AI cố tình ghét ai đó","Máy quá nóng","Lỗi màn hình"], a:0},
    {q:"Nếu chỉ dạy AI toàn ảnh táo đỏ thì?", o:["Nó có thể không nhận ra táo xanh","Nó nhận ra mọi loại quả","Nó thành thiên tài","Nó tự thêm dữ liệu"], a:0}
  ],
  ...
  "2.2.5": [
    ...
    {q:"Ngoài ảnh, máy còn có thể học phân biệt gì?", o:["Âm thanh (tiếng vỗ tay, búng tay)","Mùi hương","Vị ngọt","Nhiệt độ cơ thể"], a:0},
    {q:"Thu mẫu âm thanh nên làm ở đâu?", o:["Nơi yên tĩnh, thu nhiều lần","Nơi thật ồn ào","Chỉ thu đúng một lần","Không cần thu"], a:0}
  ],
  ...
  "2.2.6": [
    ...
    {q:"Mô hình tư thế nhận biết điều gì?", o:["Động tác cơ thể qua camera","Mùi thức ăn","Mật khẩu","Nhiệt độ phòng"], a:0},
    {q:"Để máy 'thấy' rõ động tác, em nên?", o:["Đứng ở khoảng cách và ánh sáng ổn định","Đứng trong bóng tối","Che camera lại","Nhảy thật nhanh"], a:0}
  ],
  ...
  "2.2.7": [
    ...
    {q:"Có nhiều dữ liệu hơn thường giúp gì?", o:["Giúp cải thiện, nhưng đến lúc nào đó sẽ chậm lại","Luôn làm AI kém đi","Không bao giờ giúp ích","Làm máy hỏng"], a:0},
    {q:"Ngoài 'nhiều', dữ liệu đáng giá cần gì?", o:["Đúng và đa dạng","Càng cũ càng tốt","Toàn ảnh trùng nhau","Mờ và tối"], a:0}
  ],
  ...
  "2.2.8": [
    ...
    {q:"Cách học sâu nhất một điều là?", o:["Giải thích lại cho người khác hiểu","Học thuộc lòng","Đọc thật nhanh","Không ôn gì"], a:0},
    {q:"Giải thích 'AI học thế nào' theo 3 bước là?", o:["Cho ví dụ → luyện tập → kiểm tra","Bật → tắt → nghỉ","Hỏi → quên → bỏ","Vẽ → xoá → in"], a:0}
  ],
  ...
  "2.3.1": [
    ...
    {q:"Với máy tính, một bức ảnh thực chất là gì?", o:["Lưới các con số chỉ màu từng điểm","Một bài hát","Một mùi hương","Một cơn gió"], a:0},
    {q:"Máy nhận ra vật trong ảnh bằng cách nào?", o:["So khớp mẫu (pattern), không thật sự 'hiểu'","Ngửi mùi","Đọc suy nghĩ","Hỏi người bên cạnh"], a:0}
  ],
  ...
  "2.3.2": [
    ...
    {q:"Cách nào có thể làm AI NHÌN NHẦM?", o:["Đổi góc lạ, ánh sáng quá tối/chói, che một phần vật","Chụp rõ nét, đủ sáng","Để yên không đổi gì","Chụp thật nhiều góc"], a:0},
    {q:"Biết điểm yếu của AI giúp em điều gì?", o:["Dùng nó cẩn thận hơn ở việc quan trọng","Phá hoại máy","Không có ích gì","Làm AI thông minh hơn"], a:0}
  ],
  ...
  "2.3.3": [
    ...
    {q:"Máy 'nghe' bằng cách nào?", o:["Biến âm thanh thành sóng số rồi đổi giọng nói thành văn bản","Ngửi âm thanh","Nhìn miệng người nói","Đọc ý nghĩ"], a:0},
    {q:"Khi nào máy dễ NGHE NHẦM?", o:["Khi nói nhỏ, nói nhanh, hoặc ồn ào","Khi nói rõ, chậm, nơi yên tĩnh","Không bao giờ nhầm","Khi tắt máy"], a:0}
  ],
  ...
  "2.3.4": [
    ...
    {q:"Nhận diện khuôn mặt NHẦM người có thể?", o:["Gây oan hoặc phiền toái cho người khác","Không sao cả","Làm máy vui","Tăng độ chính xác"], a:0},
    {q:"Với việc ảnh hưởng lớn đến con người, nên?", o:["Luôn có người kiểm tra lại","Giao hết cho AI quyết","Bỏ qua kiểm tra","Tin AI 100%"], a:0}
  ],
  ...
  "2.3.5": [
    ...
    {q:"Máy thường giỏi việc gì hơn người?", o:["Làm nhanh, xử lý rất nhiều ảnh, không mệt","Hiểu ngữ cảnh sâu","Nhận ra điều lạ","Phán đoán đạo đức"], a:0},
    {q:"Người thường giỏi việc gì hơn máy?", o:["Hiểu ngữ cảnh, nhận ra điều lạ, có phán đoán","Tính toán số cực lớn","Không bao giờ mệt","Xử lý triệu ảnh mỗi giây"], a:0}
  ],
  ...
  "2.3.6": [
    ...
    {q:"3 điều cần nhớ về 'máy nhìn' là?", o:["Ảnh là số; máy so mẫu chứ không hiểu; dễ nhầm khi gặp lạ","Máy hiểu y như người","Máy không bao giờ sai","Ảnh là mùi hương"], a:0},
    {q:"Kết hợp người và máy mạnh nhất khi?", o:["Máy làm phần lặp, người quyết định","Người làm hết","Máy quyết hết","Không dùng cả hai"], a:0}
  ],
  ...
  "2.4.1": [
    ...
    {q:"Nhiều AI trò chuyện hoạt động bằng cách nào?", o:["Đoán từ tiếp theo hợp lý nhất","Tra từ điển giấy","Hỏi ông Bụt","Bấm số ngẫu nhiên"], a:0},
    {q:"Ghép nhiều lần 'đoán từ tiếp theo' sẽ tạo ra?", o:["Câu, rồi thành đoạn văn","Một bức ảnh","Một bài hát","Một con số"], a:0}
  ],
  ...
  "2.4.2": [
    ...
    {q:"AI ngôn ngữ chọn từ dựa trên điều gì?", o:["Xác suất (từ 'nghe hợp'), không tra cứu sự thật","Sự thật đã kiểm chứng","Cảm xúc của nó","Thời tiết"], a:0},
    {q:"Vì sao câu AI mượt mà mà vẫn có thể sai?", o:["Viết hay không có nghĩa là nói đúng","Vì mạng chậm","Vì màn hình nhỏ","Vì thiếu pin"], a:0}
  ],
  ...
  "2.4.3": [
    ...
    {q:"'Ảo giác' (hallucination) của AI là gì?", o:["AI bịa ra thông tin không có thật","AI bị hỏng màn hình","AI hết pin","AI ngủ quên"], a:0},
    {q:"Cách 'bẫy' để thấy AI bịa là?", o:["Hỏi về nhân vật/cuốn sách không có thật","Hỏi phép tính 1+1","Khen ngợi nó","Tắt máy đi"], a:0}
  ],
  ...
  "2.4.4": [
    ...
    {q:"Điều nguy hiểm ở AI là gì?", o:["Nó trả lời rất tự tin ngay cả khi sai","Nó luôn im lặng","Nó luôn đúng","Nó sợ trả lời"], a:0},
    {q:"'Giọng chắc như đúng rồi' của AI nghĩa là?", o:["Chưa chắc đúng — vẫn phải tự kiểm tra","Chắc chắn đúng","Nó thông minh tuyệt đối","Không cần đọc lại"], a:0}
  ],
  ...
  "2.4.5": [
    ...
    {q:"Việc nào HỢP để nhờ AI?", o:["Gợi ý ý tưởng, viết nháp, giải thích khái niệm","Chốt số liệu quan trọng mà không kiểm tra","Khẳng định ngày tháng lịch sử","Xác nhận tên riêng"], a:0},
    {q:"Việc nào PHẢI kiểm chứng lại sau khi hỏi AI?", o:["Số liệu, ngày tháng, tên riêng, tin quan trọng","Xin ý tưởng đặt tên","Nhờ viết nháp","Nhờ giải thích cho vui"], a:0}
  ],
  ...
  "2.4.6": [
    ...
    {q:"Vì sao AI ngôn ngữ đôi khi bịa?", o:["Vì nó đoán từ theo xác suất, không tra sự thật","Vì nó lười","Vì trời mưa","Vì bàn phím cũ"], a:0},
    {q:"Hiểu 'vì sao AI bịa' giúp em điều gì?", o:["Không tin mù quáng và biết chỗ cần kiểm chứng","Ghét AI hơn","Ngừng dùng AI","Tin AI nhiều hơn"], a:0}
  ]
...
Object.assign(window.LESSON_QUIZ, {
  ...
  "2.5.1": [
    ...
    {q:"Công thức prompt 5 phần gồm những gì?", o:["Vai + Bối cảnh + Yêu cầu + Định dạng + Ví dụ","Mở + Thân + Kết","Tên + Tuổi + Lớp","Sáng + Trưa + Tối"], a:0},
    {q:"Prompt càng đủ phần thì?", o:["AI càng 'hiểu ý' em hơn","AI càng chậm đi","AI càng hay sai","Không khác gì cả"], a:0}
  ],
  ...
  "2.5.2": [
    ...
    {q:"'Few-shot' nghĩa là gì?", o:["Đưa vài ví dụ mẫu để AI làm theo","Hỏi thật ít","Chỉ dùng đúng một lần","Tắt máy sau vài giây"], a:0},
    {q:"Ví dụ mẫu chất lượng sẽ cho?", o:["Kết quả chất lượng, đúng 'giọng' mong muốn","Kết quả tệ hơn","Không ảnh hưởng gì","Máy bị hỏng"], a:0}
  ],
  ...
  "2.5.3": [
    ...
    {q:"Yêu cầu AI 'suy nghĩ từng bước' giúp ích gì?", o:["Bài khó (nhất là toán) chính xác hơn","AI trả lời chậm và sai","Máy nóng lên","Không có tác dụng"], a:0},
    {q:"Dù AI trình bày từng bước, em vẫn nên?", o:["Tự kiểm lại các bước","Tin tuyệt đối","Bỏ qua đáp án","Xoá đi"], a:0}
  ],
  ...
  "2.5.4": [
    ...
    {q:"Việc lớn nên xử lý thế nào với AI?", o:["Chia thành chuỗi prompt, mỗi prompt một việc","Một prompt ôm hết tất cả","Không dùng AI","Làm ngược từ cuối lên"], a:0},
    {q:"Trong chuỗi prompt, kết quả bước trước dùng để?", o:["Làm đầu vào cho bước sau","Vứt bỏ","Không liên quan","In ra giấy"], a:0}
  ],
  ...
  "2.5.5": [
    ...
    {q:"Prompt tạo hình ảnh cần mô tả rõ những gì?", o:["Chủ thể, phong cách, bố cục/màu sắc","Chỉ cần một chữ","Mật khẩu","Ngày sinh"], a:0},
    {q:"Tranh AI vẽ chưa ưng ý thì nên?", o:["Sửa mô tả rõ hơn rồi tạo lại","Bỏ cuộc","Đổ lỗi cho máy","Tắt máy"], a:0}
  ],
  ...
  "2.5.6": [
    ...
    {q:"Khi kết quả chưa ổn, việc nên làm là?", o:["Tìm xem prompt thiếu gì rồi bổ sung","Đổ lỗi cho AI ngay","Xoá ứng dụng","Gõ y hệt lại"], a:0},
    {q:"Thường điều gì giúp kết quả tốt hơn?", o:["Prompt rõ ràng hơn","Gõ nhanh hơn","Màn hình to hơn","Máy mới hơn"], a:0}
  ],
  ...
  "2.5.7": [
    ...
    {q:"'Thư viện prompt cá nhân' là gì?", o:["Lưu các prompt hay theo nhóm việc để dùng lại","Một trò chơi","Một loại pin","Danh bạ điện thoại"], a:0},
    {q:"Nên ghi kèm gì cho mỗi prompt đã lưu?", o:["Prompt này dùng cho việc gì","Số điện thoại","Mật khẩu","Ngày sinh"], a:0}
  ],
  ...
  "2.5.8": [
    ...
    {q:"Chấm 'thi đấu prompt' dựa trên tiêu chí nào?", o:["Đúng ý, rõ ràng, đủ định dạng","Ai gõ nhanh hơn","Ai lớn tuổi hơn","Ai nói to hơn"], a:0},
    {q:"Viết prompt là gì?", o:["Một kỹ năng, càng luyện càng giỏi","Việc chỉ máy làm được","Điều không thể học","Vô ích"], a:0}
  ],
  ...
  "2.6.1": [
    ...
    {q:"Quy trình kiểm chứng 3 bước là gì?", o:["Nghi ngờ → tìm nguồn gốc → đối chiếu 2 nguồn độc lập","Tin → chia sẻ → quên","Đọc → xoá → tắt","Hỏi → đoán → tin"], a:0},
    {q:"Tin thật thường xuất hiện ở đâu?", o:["Nhiều nơi uy tín","Chỉ một trang lạ","Chỉ chỗ giật gân","Không có nguồn nào"], a:0}
  ],
  ...
  "2.6.2": [
    ...
    {q:"Nguồn nào ĐÁNG TIN hơn?", o:["Báo chính thống, trang khoa học, sách","Blog cá nhân chưa rõ nguồn","Bài đăng ẩn danh trên mạng","Tin nhắn lạ"], a:0},
    {q:"Để đánh giá một nguồn, nên xem gì?", o:["Ai viết, viết khi nào, có dẫn nguồn không","Màu nền trang","Có nhiều ảnh không","Chữ to hay nhỏ"], a:0}
  ],
  ...
  "2.6.3": [
    ...
    {q:"Dấu hiệu nhận biết ảnh/video deepfake?", o:["Chi tiết bất thường ở bàn tay, mắt, ánh sáng, chữ","Ảnh quá rõ nét","Có nhiều màu sắc","Kích thước lớn"], a:0},
    {q:"'Thấy tận mắt' ngày nay?", o:["Không còn chắc là thật — hãy kiểm nguồn","Luôn luôn là thật","Không cần kiểm tra","Chắc chắn đúng"], a:0}
  ],
  ...
  "2.6.4": [
    ...
    {q:"Nhận cuộc gọi 'người quen' xin tiền gấp, em nên?", o:["Gọi lại số quen thuộc để xác minh và báo người lớn","Chuyển tiền ngay","Làm theo vì bị hối thúc","Cho luôn thông tin"], a:0},
    {q:"Chiêu thường gặp của kẻ lừa đảo là?", o:["Hối thúc để em làm theo ngay","Cho em thật nhiều thời gian","Khuyên em kiểm tra kỹ","Bảo em hỏi ba mẹ"], a:0}
  ],
  ...
  "2.6.5": [
    ...
    {q:"Cách kiểm chứng chính AI là gì?", o:["Bắt nó dẫn nguồn rồi kiểm nguồn có thật không","Tin ngay lời AI","Hỏi lại y hệt","Khen ngợi nó"], a:0},
    {q:"Đôi khi AI còn có thể làm gì?", o:["Bịa ra cả nguồn không có thật","Luôn dẫn nguồn đúng","Không bao giờ sai","Tự sửa mọi lỗi"], a:0}
  ],
  ...
  "2.6.6": [
    ...
    {q:"Cẩm nang kiểm chứng bỏ túi gồm?", o:["Nghi ngờ → tìm nguồn → đối chiếu 2 nguồn; cảnh giác ảnh/giọng giả","Tin mọi thứ","Chia sẻ thật nhanh","Không đọc gì"], a:0},
    {q:"Trước khi tin và chia sẻ một tin, nên?", o:["Kiểm chứng cẩn thận","Chia sẻ ngay","Tin vì thấy giật gân","Bình luận tức giận"], a:0}
  ],
  ...
  "2.7.1": [
    ...
    {q:"Đâu là dữ liệu cá nhân cần bảo vệ?", o:["Tên đầy đủ, ảnh, địa chỉ nhà, số điện thoại","Màu em thích","Tên loài hoa","Món ăn ngon"], a:0},
    {q:"Với AI hay người lạ trên mạng, em nên?", o:["Không đưa thông tin cá nhân nhạy cảm","Chia sẻ hết cho tiện","Cho địa chỉ nhà","Gửi ảnh giấy tờ"], a:0}
  ],
  ...
  "2.7.2": [
    ...
    {q:"Nhiều dịch vụ AI có thể làm gì với hội thoại?", o:["Lưu lại hội thoại của em","Đọc suy nghĩ của em","Tự xoá mọi thứ ngay","Không lưu gì bao giờ"], a:0},
    {q:"Vì AI có thể lưu hội thoại, em nên?", o:["Cẩn thận điều mình gõ; chỉnh cài đặt riêng tư","Gõ hết bí mật vào","Cho mật khẩu","Không quan tâm"], a:0}
  ],
  ...
  "2.7.3": [
    ...
    {q:"Bài do AI làm hộ thì?", o:["Không hoàn toàn là của em; nên nói thật khi có dùng AI","Là của em 100%","Nên nhận là mình tự làm","Nên giấu đi"], a:0},
    {q:"Nên dùng AI để làm gì?", o:["Giúp em học và làm tốt hơn","Làm hết mọi việc thay em","Gian lận","Bắt nạt bạn"], a:0}
  ],
  ...
  "2.7.4": [
    ...
    {q:"'Hiến chương AI' của em nên có những điều gì?", o:["Trung thực, không hại ai, bảo vệ thông tin, luôn kiểm chứng","Dùng AI để lừa người","Chia sẻ mật khẩu","Tin AI 100%"], a:0},
    {q:"Nên chia sẻ hiến chương AI với ai?", o:["Ba mẹ, để cùng thống nhất cách dùng","Không ai cả","Người lạ trên mạng","Giữ bí mật tuyệt đối"], a:0}
  ],
  ...
  "2.8.1": [
    ...
    {q:"Dự án cuối Level 2 nên chọn vấn đề như thế nào?", o:["Vấn đề máy có thể giúp phân loại (rác, lá cây…)","Không liên quan gì tới AI","Quá khó, không thu được dữ liệu","Của người khác"], a:0},
    {q:"Đề tài dễ thành công là?", o:["Vừa sức, dữ liệu dễ thu thập","Càng khó càng tốt","Không cần dữ liệu","Mơ hồ"], a:0}
  ],
  ...
  "2.8.2": [
    ...
    {q:"Thu thập dữ liệu tốt cần đảm bảo gì?", o:["Đa dạng, đủ mỗi nhóm, nhiều góc và điều kiện","Chỉ một góc duy nhất","Càng ít càng tốt","Toàn ảnh giống hệt nhau"], a:0},
    {q:"Dữ liệu bị lệch sẽ khiến mô hình?", o:["Có điểm mù","Trở nên hoàn hảo","Chạy nhanh hơn","Đẹp hơn"], a:0}
  ],
  ...
  "2.8.3": [
    ...
    {q:"Nên đo độ chính xác của mô hình trên gì?", o:["Vật mới, chưa dùng để học","Chính ảnh đã học","Không cần đo","Ảnh của người khác"], a:0},
    {q:"Khi thấy mô hình hay sai ở đâu, nên?", o:["Ghi lại để biết cần bổ sung dữ liệu gì","Giấu đi","Bỏ luôn dự án","Đổ lỗi cho máy"], a:0}
  ],
  ...
  "2.8.4": [
    ...
    {q:"'Kiểm chứng chéo' là gì?", o:["Nhờ bạn khác thử phá mô hình của em","Tự khen mô hình","Xoá mô hình","Không cho ai xem"], a:0},
    {q:"Bị bạn 'phá' mô hình giúp ích gì?", o:["Giúp mô hình mạnh hơn","Làm mô hình dở đi","Hoàn toàn vô ích","Nên bỏ cuộc"], a:0}
  ],
  ...
  "2.8.5": [
    ...
    {q:"Bản thuyết minh 1 trang nên nêu những gì?", o:["Giải vấn đề gì, cho ai, mô hình hoạt động ra sao, độ chính xác","Chỉ tên em","Màu yêu thích","Không cần gì"], a:0},
    {q:"Nên viết thuyết minh thế nào?", o:["Đơn giản, dễ hiểu, kèm ví dụ","Càng khó hiểu càng hay","Thật dài dòng","Để không ai đọc được"], a:0}
  ],
  ...
  "2.8.6": [
    ...
    {q:"Trình bày Demo Day Level 2 theo mạch nào?", o:["Vấn đề → dữ liệu → mô hình → kết quả → điều học được","Chào → tạm biệt","Chỉ đọc code","Không trình bày"], a:0},
    {q:"Nên chuẩn bị gì cho phần hỏi đáp?", o:["1–2 câu trả lời cho câu hỏi hay gặp","Không chuẩn bị gì","Trốn câu hỏi","Đọc thật nhanh"], a:0}
  ]
...
Object.assign(window.LESSON_QUIZ, {
  ...
  "3.1.1": [
    ...
    {q:"Một sản phẩm tốt là gì?", o:["Thứ giải quyết vấn đề cho người khác","Thứ chỉ mình em thích","Món đồ đắt tiền","Thứ có nhiều màu"], a:0},
    {q:"Một sản phẩm thường bắt đầu từ?", o:["Một nhu cầu có thật","Sự ngẫu nhiên","Màu sắc đẹp","Giá bán cao"], a:0}
  ],
  ...
  "3.1.2": [
    ...
    {q:"'Săn vấn đề' nghĩa là gì?", o:["Quan sát khó khăn của người quanh em","Đi săn thú","Chơi game","Đi mua đồ"], a:0},
    {q:"'Sổ săn vấn đề' dùng để làm gì?", o:["Ghi lại mọi khó khăn em thấy","Ghi điểm số","Vẽ tranh","Chép bài"], a:0}
  ],
  ...
  "3.1.3": [
    ...
    {q:"Lọc ý tưởng dựa trên 3 câu hỏi nào?", o:["Có thật không? Làm nổi không? Em có thích không?","Đắt không? Đẹp không? Lạ không?","Ai? Ở đâu? Khi nào?","To? Nặng? Xa?"], a:0},
    {q:"Nên làm gì TRƯỚC khi lọc ý tưởng?", o:["Brainstorm thật rộng, chưa vội chê","Chọn ngay ý đầu tiên","Bỏ hết ý tưởng","Chép của người khác"], a:0}
  ],
  ...
  "3.1.4": [
    ...
    {q:"Khi chốt hướng đi, nên viết rõ điều gì?", o:["Vấn đề là gì, ai gặp, vì sao em chọn","Chỉ tên em","Màu yêu thích","Giá bán"], a:0},
    {q:"Nên chọn vấn đề để theo đuổi thế nào?", o:["Vấn đề em thật sự quan tâm","Vấn đề khó nhất","Vấn đề của người khác","Vấn đề không liên quan"], a:0}
  ],
  ...
  "3.2.1": [
    ...
    {q:"Vì sao phải hỏi người dùng thật?", o:["Điều em nghĩ họ cần thường khác điều họ thật sự cần","Vì cho vui","Để khoe","Không cần hỏi"], a:0},
    {q:"Nhiều sản phẩm thất bại vì?", o:["Người làm chỉ đoán, không hỏi người thật","Vì quá đẹp","Vì quá rẻ","Vì có màu xanh"], a:0}
  ],
  ...
  "3.2.2": [
    ...
    {q:"Câu hỏi nào cho NHIỀU thông tin hơn?", o:["Câu hỏi mở ('Bạn thường gặp khó gì khi…?')","Câu hỏi mớm ('tiện đúng không?')","Câu chỉ trả lời có/không","Không hỏi gì"], a:0},
    {q:"Nên hỏi người dùng về điều gì?", o:["Trải nghiệm thật đã xảy ra","Phỏng đoán tương lai","Điều em muốn nghe","Chuyện không liên quan"], a:0}
  ],
  ...
  "3.2.3": [
    ...
    {q:"Khi phỏng vấn, nên ghi chép thế nào?", o:["Ghi nhanh ý chính","Chép từng chữ một","Không ghi gì","Ghi lại sau vài ngày"], a:0},
    {q:"Sau một câu trả lời hay, nên hỏi tiếp gì?", o:["'Vì sao vậy?' để hiểu sâu hơn","'Xong chưa?'","Không hỏi thêm","Đổi chủ đề"], a:0}
  ],
  ...
  "3.2.4": [
    ...
    {q:"Trước khi ghi chép lúc phỏng vấn, em nên?", o:["Xin phép, và cảm ơn sau khi phỏng vấn","Ghi lén","Không cần xin phép","Quay phim không hỏi"], a:0},
    {q:"Cuộc phỏng vấn số 1 nên hỏi về?", o:["Đúng vấn đề em đã chọn","Chuyện phiếm","Điểm số của họ","Bí mật cá nhân"], a:0}
  ],
  ...
  "3.2.5": [
    ...
    {q:"Khi nhiều người cùng nói một khó khăn, đó là?", o:["Tín hiệu mạnh đáng để giải quyết","Chuyện tình cờ","Điều nên bỏ qua","Lỗi phỏng vấn"], a:0},
    {q:"Phỏng vấn thêm 2–3 người để làm gì?", o:["Thấy điều gì lặp lại giữa các cuộc","Cho vui","Tốn thời gian","Không vì lý do gì"], a:0}
  ],
  ...
  "3.2.6": [
    ...
    {q:"'Insight' là gì?", o:["Một điều bất ngờ, sâu sắc rút ra từ phỏng vấn","Điều ai cũng đã biết","Một con số","Tên sản phẩm"], a:0},
    {q:"Một insight tốt khiến em?", o:["Muốn thốt lên 'à, thì ra là vậy!'","Buồn ngủ","Muốn bỏ cuộc","Quên hết"], a:0}
  ],
  ...
  "3.3.1": [
    ...
    {q:"Từ insight, nên chọn giải pháp nào?", o:["Cách nhỏ nhất mà vẫn hữu ích","Cách phức tạp nhất","Cách đắt nhất","Cách của người khác"], a:0},
    {q:"Khi chọn giải pháp, nên tập làm gì?", o:["Bảo vệ lựa chọn: 'Em chọn cách này vì…'","Giấu lý do","Không giải thích","Chọn đại"], a:0}
  ],
  ...
  "3.3.2": [
    ...
    {q:"MVP là gì?", o:["Phiên bản nhỏ nhất chạy được, giải quyết vấn đề cốt lõi","Phiên bản đầy đủ mọi tính năng","Một bản vẽ tay","Một trò chơi"], a:0},
    {q:"Làm MVP nên?", o:["Cắt tính năng 'cho vui', giữ phần cốt lõi","Thêm thật nhiều tính năng","Bỏ phần quan trọng","Làm thật to"], a:0}
  ],
  ...
  "3.3.3": [
    ...
    {q:"Wireframe là gì?", o:["Bản phác giấy các màn hình trước khi làm thật","Một loại dây điện","Code hoàn chỉnh","Một trò chơi"], a:0},
    {q:"Vì sao nên vẽ tay wireframe?", o:["Nhanh và dễ sửa hơn làm rồi mới đổi","Cho đẹp","Cho tốn kém","Cho khó sửa"], a:0}
  ],
  ...
  "3.3.4": [
    ...
    {q:"Cho người dùng duyệt wireframe để làm gì?", o:["Sửa sớm trước khi tốn công làm thật","Khoe bản vẽ","Cho vui","Không vì lý do gì"], a:0},
    {q:"Sửa trên giấy so với sửa trên sản phẩm thật?", o:["Rẻ và nhanh hơn","Đắt hơn","Chậm hơn","Khó hơn"], a:0}
  ],
  ...
  "3.4.1": [
    ...
    {q:"Trong Python, lệnh print(...) dùng để?", o:["In ra màn hình","Tắt máy","Xoá tệp","Vẽ hình"], a:0},
    {q:"Python so với Scratch thì?", o:["Thay khối kéo–thả bằng chữ, ý tưởng vẫn thế","Hoàn toàn khác nhau","Không liên quan","Khó gấp trăm lần"], a:0}
  ],
  ...
  "3.4.2": [
    ...
    {q:"if/else trong Python giống gì ở Scratch?", o:["Khối 'Nếu… thì…'","Vòng lặp","Nhân vật","Sân khấu"], a:0},
    {q:"Python dùng gì để biết câu lệnh thuộc nhánh nào?", o:["Thụt lề (khoảng trắng đầu dòng)","Màu chữ","Dấu chấm","Số dòng"], a:0}
  ],
  ...
  "3.4.3": [
    ...
    {q:"Vòng lặp 'for' trong Python dùng để?", o:["Lặp qua từng phần tử của một danh sách","Tắt máy","Vẽ hình","In đúng một lần"], a:0},
    {q:"Vòng lặp 'while' lặp khi nào?", o:["Chừng nào điều kiện còn đúng","Chỉ đúng 1 lần","Mãi mãi không dừng được","Không bao giờ"], a:0}
  ],
  ...
  "3.4.4": [
    ...
    {q:"Danh sách (list) trong Python dùng để?", o:["Lưu nhiều thứ; có thể thêm, đếm, tìm kiếm","Lưu đúng 1 số","Tắt máy","Vẽ tranh"], a:0},
    {q:"Chuỗi (string) là gì?", o:["Một dãy ký tự","Một con số duy nhất","Một hình ảnh","Một âm thanh"], a:0}
  ],
  ...
  "3.4.5": [
    ...
    {q:"Hàm (function) giúp ích gì?", o:["Gói code lại để dùng nhiều lần","Tắt máy","Xoá dữ liệu","Làm chậm máy"], a:0},
    {q:"Khi nào nên gói code thành hàm?", o:["Khi một đoạn code lặp lại nhiều lần","Khi chỉ dùng 1 lần","Không bao giờ","Khi code rất ngắn"], a:0}
  ],
  ...
  "3.4.6": [
    ...
    {q:"Với code do AI viết, em nên làm gì?", o:["Đọc hiểu, chạy thử và tìm chỗ sai","Chạy ngay không đọc","Tin tuyệt đối","Xoá đi"], a:0},
    {q:"Vì sao không nên chạy code lạ mà không hiểu?", o:["AI không phải lúc nào cũng đúng; hiểu rồi mới dùng","Vì code luôn đúng","Vì cho vui","Vì máy nhanh"], a:0}
  ],
  ...
  "3.4.7": [
    ...
    {q:"Khi code AI viết bị sai, em có thể?", o:["Nhờ AI sửa (mô tả lỗi rõ) hoặc tự sửa tay","Chỉ biết bỏ đi","Không sửa được","Đổ lỗi cho máy"], a:0},
    {q:"So sánh hai cách sửa code giúp em?", o:["Hiểu vì sao code chạy đúng","Tốn thời gian vô ích","Không học được gì","Làm hỏng code"], a:0}
  ],
  ...
  "3.4.8": [
    ...
    {q:"Mini game console dùng những kiến thức nào?", o:["Biến, if/else, vòng lặp và hàm","Chỉ hình ảnh 3D","Chỉ âm thanh","Không dùng gì"], a:0},
    {q:"Nên làm phần nào của game trước?", o:["Phần chơi được, thêm điểm/lời nhắn sau","Trang trí trước","Phần khó nhất trước","Làm hết rồi mới thử"], a:0}
  ]
...
Object.assign(window.LESSON_QUIZ, {
  ...
  "3.5.1": [
    ...
    {q:"Ba cách xây MVP thường gặp là?", o:["Vibe coding, no-code, code tay","Vẽ, hát, múa","Đọc, viết, xoá","Mua, bán, đổi"], a:0},
    {q:"Nên chọn công cụ làm sản phẩm thế nào?", o:["Hợp với sản phẩm và sức của em","Chọn cái 'oách nhất'","Cái đắt nhất","Cái bạn đang dùng"], a:0}
  ],
  ...
  "3.5.2": [
    ...
    {q:"Nên dựng gì TRƯỚC khi làm đầy đủ tính năng?", o:["Khung sản phẩm / màn hình chính mở lên được","Tất cả tính năng cùng lúc","Phần trang trí","Video quảng cáo"], a:0},
    {q:"Có khung chạy được sớm giúp gì?", o:["Thấy tiến độ và giữ động lực","Tốn thời gian","Không có ích","Làm rối"], a:0}
  ],
  ...
  "3.5.3": [
    ...
    {q:"Tính năng cốt lõi số 1 là gì?", o:["Phần giải quyết đúng vấn đề chính","Phần trang trí","Phần cho vui","Phần ít dùng"], a:0},
    {q:"Nếu tính năng lõi không chạy thì?", o:["Các thứ khác không cứu được sản phẩm","Vẫn ổn","Không sao cả","Tự sửa được"], a:0}
  ],
  ...
  "3.5.4": [
    ...
    {q:"Sau khi làm 2 tính năng cốt lõi, cần làm gì?", o:["Kết nối chúng, đảm bảo luồng liền mạch","Bỏ bớt một cái","Không cần nối","Làm thêm 10 cái"], a:0},
    {q:"Cách phát hiện chỗ 'gãy' trong luồng dùng?", o:["Đi hết một lượt như người dùng thật","Không thử gì","Hỏi máy","Đoán bừa"], a:0}
  ],
  ...
  "3.5.5": [
    ...
    {q:"Vì sao nên thay dữ liệu giả bằng dữ liệu thật?", o:["Thấy sản phẩm gần thực tế, lộ vấn đề mà dữ liệu giả che mất","Cho đẹp","Cho vui","Không cần thiết"], a:0},
    {q:"Nên nhập loại dữ liệu nào để kiểm tra?", o:["Vài trường hợp 'khó'","Chỉ trường hợp dễ","Không nhập gì","Dữ liệu trùng nhau"], a:0}
  ],
  ...
  "3.5.6": [
    ...
    {q:"Mô tả lỗi cho AI hiệu quả gồm?", o:["Làm gì → mong đợi gì → thực tế ra sao","Chỉ nói 'lỗi rồi'","Không mô tả","Khen AI"], a:0},
    {q:"Sau khi AI đưa bản sửa, em nên?", o:["Kiểm tra lại bản sửa","Chạy ngay không xem","Tin tuyệt đối","Xoá đi"], a:0}
  ],
  ...
  "3.5.7": [
    ...
    {q:"'Làm đẹp vừa đủ' nghĩa là gì?", o:["Dễ dùng quan trọng hơn hào nhoáng","Càng nhiều hiệu ứng càng tốt","Trang trí thật rối","Bỏ qua bố cục"], a:0},
    {q:"Người dùng cần điều gì hơn?", o:["Dễ hiểu, dễ bấm","Nhiều hiệu ứng","Màu chói","Nhạc nền to"], a:0}
  ],
  ...
  "3.5.8": [
    ...
    {q:"'Tổng duyệt nội bộ' là gì?", o:["Cả lớp dùng thử chéo, ghi lỗi lần cuối","Tự khen mình","Không cho ai xem","Ra mắt luôn"], a:0},
    {q:"Nên ưu tiên sửa lỗi nào?", o:["Lỗi khiến người dùng không dùng tiếp được","Lỗi nhỏ nhất","Lỗi màu sắc","Không sửa gì"], a:0}
  ],
  ...
  "3.6.1": [
    ...
    {q:"Khi test, cần nhớ em đang test cái gì?", o:["Test sản phẩm, không phải test người dùng","Test trí nhớ người dùng","Test tốc độ đọc","Test máy tính"], a:0},
    {q:"Kịch bản test nên xác định gì?", o:["Nhờ họ làm việc gì + em quan sát điều gì","Chỉ số điểm","Màu áo họ","Tuổi họ"], a:0}
  ],
  ...
  "3.6.2": [
    ...
    {q:"Trong buổi test, em nên làm gì?", o:["Quan sát yên lặng, không nhắc","Nhắc liên tục","Làm hộ họ","Giải thích mọi bước"], a:0},
    {q:"Chỗ người dùng lúng túng chính là?", o:["Chỗ sản phẩm cần cải thiện","Lỗi của họ","Điều không quan trọng","Chỗ đẹp nhất"], a:0}
  ],
  ...
  "3.6.3": [
    ...
    {q:"Khi phân tích lỗi, nên làm gì?", o:["Chia theo nặng–nhẹ, sửa cái quan trọng nhất trước","Sửa hết cùng lúc","Bỏ qua tất cả","Chỉ sửa lỗi nhỏ"], a:0},
    {q:"Lỗi nào cần ưu tiên sửa?", o:["Lỗi khiến người dùng không tiếp tục được","Lỗi màu","Lỗi chính tả nhỏ","Không lỗi nào"], a:0}
  ],
  ...
  "3.6.4": [
    ...
    {q:"Buổi test số 2 nên làm gì?", o:["Cho người mới thử bản đã sửa","Cho đúng người cũ thử lại","Không test nữa","Bỏ qua"], a:0},
    {q:"Vì sao nên test với người mới?", o:["Có góc nhìn tươi, không quen sản phẩm","Cho vui","Tốn thời gian","Không lý do"], a:0}
  ],
  ...
  "3.6.5": [
    ...
    {q:"Sản phẩm tốt lên nhờ điều gì?", o:["Nhiều vòng thử – sửa","Làm một lần là xong","Không sửa gì","May mắn"], a:0},
    {q:"Sau khi sửa đợt 2, em có được?", o:["Một bản ổn định hơn (1.1)","Bản tệ hơn","Không đổi gì","Bản chưa chạy"], a:0}
  ],
  ...
  "3.6.6": [
    ...
    {q:"Cho người dùng chấm điểm để làm gì?", o:["Nhận phản hồi thẳng thắn","Khoe điểm cao","Cho vui","Không vì sao"], a:0},
    {q:"Phản hồi thật (dù khó nghe) thì?", o:["Quý hơn lời khen xã giao","Nên bỏ qua","Nên tránh vì làm buồn","Vô ích"], a:0}
  ],
  ...
  "3.7.1": [
    ...
    {q:"Sản phẩm cần gì để người khác dễ nhớ?", o:["Tên dễ nhớ + câu 'giúp ai làm được gì'","Giá thật cao","Nhiều màu","Logo phức tạp"], a:0},
    {q:"Cách chọn tên tốt là?", o:["Thử vài tên, hỏi bạn tên nào dễ nhớ","Chọn tên dài nhất","Chọn tên khó đọc","Không cần tên"], a:0}
  ],
  ...
  "3.7.2": [
    ...
    {q:"Trang giới thiệu nên nêu gì?", o:["Vấn đề → giải pháp → ảnh chụp sản phẩm","Chỉ tên em","Danh sách bạn bè","Số điện thoại"], a:0},
    {q:"Nên đặt gì lên đầu trang giới thiệu?", o:["Lợi ích cho người dùng","Danh sách tính năng khô khan","Giá bán","Lời cảm ơn dài"], a:0}
  ],
  ...
  "3.7.3": [
    ...
    {q:"Video demo 60 giây nên có gì?", o:["Vấn đề, thao tác chính, kết quả","Chỉ nhạc nền","Cảnh quay dài lan man","Không có nội dung"], a:0},
    {q:"Vì sao nên viết kịch bản trước khi quay?", o:["Để 60 giây không bị lan man","Cho khó hơn","Cho dài hơn","Không cần thiết"], a:0}
  ],
  ...
  "3.7.4": [
    ...
    {q:"Nên đưa sản phẩm cho ai dùng thử?", o:["5–10 người đúng nhóm gặp vấn đề","Không cho ai","Chỉ mình em","Người không liên quan"], a:0},
    {q:"Sản phẩm có ý nghĩa khi nào?", o:["Khi có người dùng thật","Khi để trong máy","Khi có nhiều màu","Khi đắt tiền"], a:0}
  ],
  ...
  "3.7.5": [
    ...
    {q:"Theo dõi tuần đầu để biết điều gì?", o:["Ai dùng, dùng phần nào, bỏ ở đâu","Màu áo người dùng","Thời tiết","Điểm số của lớp"], a:0},
    {q:"Cần gì để bắt đầu theo dõi?", o:["Một bảng theo dõi đơn giản","Phần mềm đắt tiền","Không cần gì","Máy chủ lớn"], a:0}
  ],
  ...
  "3.7.6": [
    ...
    {q:"Rút bài học sau ra mắt gồm những gì?", o:["Điều gì hiệu quả, điều gì sẽ làm khác","Chỉ ăn mừng","Quên hết","Đổ lỗi cho người khác"], a:0},
    {q:"Mỗi lần ra mắt được xem là?", o:["Một lần học — thất bại nhỏ cũng quý","Một lần thất bại hoàn toàn","Vô nghĩa","Chỉ để khoe"], a:0}
  ],
  ...
  "3.8.1": [
    ...
    {q:"Cấu trúc một bài pitch là?", o:["Vấn đề → Giải pháp → Demo → Phản hồi → Bước tiếp","Chào → Tạm biệt","Chỉ đọc slide","Kể chuyện cười"], a:0},
    {q:"Nên mở đầu pitch thế nào?", o:["Một câu chuyện/tình huống cho thấy vấn đề là thật","Đọc thông số kỹ thuật","Xin lỗi khán giả","Im lặng"], a:0}
  ],
  ...
  "3.8.2": [
    ...
    {q:"Slide kể chuyện nên như thế nào?", o:["Ít chữ, nhiều hình, có số liệu thật","Nhiều đoạn văn dài","Toàn chữ nhỏ","Trống trơn"], a:0},
    {q:"Slide dùng để làm gì?", o:["Hỗ trợ lời nói, không đọc nguyên văn","Đọc y nguyên","Thay hẳn người nói","Chỉ trang trí"], a:0}
  ],
  ...
  "3.8.3": [
    ...
    {q:"'Tổng duyệt lần 1' là gì?", o:["Pitch thử trước lớp, nhận góp ý theo tiêu chí","Ra mắt luôn","Không cần luyện","Chỉ xem slide"], a:0},
    {q:"Nên làm gì với góp ý nhận được?", o:["Ghi lại ngay để không quên khi sửa","Bỏ qua","Cãi lại","Giận dỗi"], a:0}
  ],
  ...
  "3.8.4": [
    ...
    {q:"Tổng duyệt lần 2 tập trung vào?", o:["Pitch bản đã sửa + luyện trả lời câu hỏi khó","Làm slide mới hoàn toàn","Nghỉ ngơi","Đổi đề tài"], a:0},
    {q:"Không biết câu trả lời thì nên?", o:["Thành thật: 'Em sẽ tìm hiểu thêm'","Bịa đại một câu","Im lặng bỏ đi","Đổ lỗi"], a:0}
  ],
  ...
  "3.8.5": [
    ...
    {q:"Ở Demo Day, em nên?", o:["Bình tĩnh, kể mạch lạc, cho xem demo thật","Đọc thật vội","Trốn tránh","Không chuẩn bị"], a:0},
    {q:"Làm gì để tránh sự cố phút chót?", o:["Đến sớm kiểm tra máy móc","Đến thật muộn","Không kiểm tra gì","Tắt máy đi"], a:0}
  ],
  ...
  "3.8.6": [
    ...
    {q:"Tổng kết cuối Level 3 gồm những gì?", o:["Nhìn lại đã học/làm được gì, hoàn thiện hồ sơ sản phẩm","Chỉ ăn mừng","Quên hết","Xoá sản phẩm"], a:0},
    {q:"Điều đáng tự hào nhất là gì?", o:["Em đã tự tay tạo ra một sản phẩm thật","Có nhiều điểm","Được khen","Làm xong nhanh"], a:0}
  ]
