...
const BANK = {
  1: [
    ...
    {topic:"ungdung", q:"Ứng dụng bản đồ chỉ đường dùng AI để làm gì?", opts:["Gợi ý đường đi nhanh, tránh kẹt xe","Nấu bữa tối","Giặt đồ","Tưới cây"], a:0},
    {topic:"khainiem", q:"Chatbot (trợ lý trò chuyện) có thể làm gì?", opts:["Trả lời câu hỏi bằng chữ","Nấu ăn giúp em","Quét nhà","Gấp chăn"], a:0},
    {topic:"antoan", q:"Khi trò chuyện với AI, em nên xưng hô thế nào?", opts:["Lịch sự, không nói lời thô tục","Chửi bới cho vui","Doạ nạt nó","La hét thật to"], a:0},
    {topic:"hoatdong", q:"Muốn AI hát hay hơn, người ta cho nó nghe gì?", opts:["Nhiều bài hát để học","Một cốc nước","Ánh nắng","Không cần gì"], a:0},
    {topic:"ungdung", q:"Camera điện thoại 'làm đẹp' khuôn mặt là nhờ gì?", opts:["AI nhận diện khuôn mặt","Cục pin","Đèn pin","Loa ngoài"], a:0},
    {topic:"khainiem", q:"AI có phải là người thật không?", opts:["Không, AI là chương trình máy tính","Có, AI là người tí hon","AI là con vật","AI là đồ ăn"], a:0},
    {topic:"prompt", q:"Muốn AI giúp, trước tiên em phải làm gì?", opts:["Nói/gõ yêu cầu rõ ràng","Ngồi im chờ","Tắt máy","Vẽ lên màn hình"], a:0},
    {topic:"antoan", q:"Nếu AI nói điều gì làm em thấy sợ hoặc khó chịu, nên làm gì?", opts:["Dừng lại và kể cho ba mẹ/thầy cô","Tin theo ngay","Giấu không nói ai","Làm theo cho xong"], a:0},
  ],
  2: [
    ...
    {topic:"hoatdong", q:"'Dữ liệu huấn luyện' của AI là gì?", opts:["Các ví dụ dùng để dạy AI","Pin dự phòng của máy","Tên một trò chơi","Loại dây sạc"], a:0},
    {topic:"prompt", q:"Prompt nào giúp AI trả lời đúng ý hơn?", opts:["Nói rõ mục tiêu, đối tượng và độ dài","Chỉ gõ một dấu chấm","Gõ thật nhiều câu vô nghĩa","Để trống"], a:0},
    {topic:"antoan", q:"AI 'ảo giác' (hallucination) nghĩa là gì?", opts:["AI bịa ra thông tin nghe rất thật nhưng sai","AI bị hỏng màn hình","AI hết pin","AI nói tiếng nước ngoài"], a:0},
    {topic:"ungdung", q:"Email tự động đưa thư rác vào mục 'Spam' là nhờ gì?", opts:["AI phân loại thư","Bác đưa thư","Máy in","Nút nguồn"], a:0},
    {topic:"khainiem", q:"Vì sao nói AI 'hẹp' giỏi từng việc cụ thể?", opts:["Nó được tạo để làm tốt một loại việc","Nó biết làm mọi thứ như người","Nó có cảm xúc","Nó tự sống được"], a:0},
    {topic:"antoan", q:"Bạn gửi cho em ảnh 'người nổi tiếng' phát biểu lạ. Em nên?", opts:["Nghi ngờ có thể là deepfake, kiểm chứng lại","Tin và chia sẻ ngay","Bình luận chê bai","Lưu về làm bằng chứng"], a:0},
    {topic:"prompt", q:"Sau khi AI trả lời chưa ưng ý, em nên làm gì?", opts:["Nói rõ hơn để AI chỉnh lại","Đập bàn phím","Bỏ cuộc luôn","Khen đại cho xong"], a:0},
    {topic:"ungdung", q:"AI dịch ngôn ngữ hoạt động tốt nhất khi nào?", opts:["Câu rõ ràng, đúng chính tả","Câu viết tắt lung tung","Không có dấu câu","Toàn ký tự lạ"], a:0},
  ],
  3: [
    ...
    {topic:"antoan", q:"Vì sao AI đôi khi trả lời 'thiên vị' (không công bằng)?", opts:["Do dữ liệu học bị lệch, thiếu đa dạng","Do AI cố tình ghét ai đó","Do AI buồn ngủ","Do trời mưa"], a:0},
    {topic:"antoan", q:"Dùng AI làm bài rồi nhận là hoàn toàn của mình là?", opts:["Thiếu trung thực","Rất sáng tạo","Được khuyến khích","Không sao cả"], a:0},
    {topic:"prompt", q:"Cách viết prompt nào thường cho kết quả kém?", opts:["Mơ hồ, thiếu thông tin quan trọng","Nêu rõ bối cảnh","Cho ví dụ mẫu","Nói rõ độ dài"], a:0},
    {topic:"hoatdong", q:"Vì sao cùng một câu hỏi, AI có thể trả lời khác nhau?", opts:["Nó chọn trong nhiều khả năng hợp lý","Vì nó nhớ nhầm","Vì nó giận em","Vì máy hỏng"], a:0},
    {topic:"khainiem", q:"Câu nào mô tả ĐÚNG giới hạn của AI hiện nay?", opts:["Không thật sự 'hiểu' như người, chỉ dự đoán theo dữ liệu","Có ý thức và cảm xúc thật","Luôn đúng mọi lúc","Tự chịu trách nhiệm thay người dùng"], a:0},
    {topic:"antoan", q:"Trước khi chia sẻ ảnh do AI tạo, điều nên làm là?", opts:["Ghi rõ đây là ảnh do AI tạo để không gây hiểu lầm","Nói dối là ảnh thật","Giấu nguồn gốc","Chỉnh cho giống thật hơn nữa"], a:0},
    {topic:"ungdung", q:"Đâu là ví dụ dùng AI có ích và tử tế?", opts:["Nhờ AI giải thích bài khó để tự hiểu","Nhờ AI viết lời trêu chọc bạn","Tạo tin giả cho vui","Giả giọng người khác để lừa"], a:0},
    {topic:"prompt", q:"Khi cần thông tin chính xác từ AI, em nên?", opts:["Yêu cầu AI nêu nguồn và tự kiểm chứng lại","Tin ngay câu đầu tiên","Chỉ cần câu trả lời dài là đúng","Không cần kiểm tra"], a:0},
  ],
};
...
function _authMsg(text, ok){
  ...
  if(m){ m.textContent = text; m.className = "authMsg" + (ok ? " ok" : text ? " err" : ""); }
}
async function authSubmit(){
  if(!window.Cloud || !Cloud.enabled){ _authMsg("Đồng bộ chưa được bật (thiếu cấu hình)."); return; }
